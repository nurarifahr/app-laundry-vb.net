...
Public Class FormDataJasa
    ...
    Sub delete()
        ...
        If a = "" Then
            MsgBox("Data Jasa yang dihapus belum dipilih")
        Else
            If (MessageBox.Show("Anda yakin menghapus data dengan Kode_Jasa = " & a & " ? ", "Delete", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.OK) Then
                Koneksi()
                cmd = New OdbcCommand("delete from tb_jasa where Kode_Jasa='" & a & "'", con)
                cmd.ExecuteNonQuery()
                MsgBox("Menghapus data jasa BERHASIL", vbInformation, "INFORMASI")
                con.Close()
                tampil_data()
            End If
        End If
    End Sub
    Private Sub FormDataJasa_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Call tampil_data()
        Call bersih()
    End Sub
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Call Koneksi()
        Dim simpan As String = "insert into tb_jasa values ('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "')"
    ...
    Private Sub Button3_Click(sender As System.Object, e As System.EventArgs) Handles Button3.Click
        Call Koneksi()
        Dim edit As String = "update tb_jasa set Nama_Jasa= '" & TextBox2.Text & "',Satuan= '" & TextBox3.Text & "',Harga= '" & TextBox4.Text & "' where Kode_Jasa='" & TextBox1.Text & "'"
